...
df_by_team.to_csv('salaries_per_team.csv',index = False)
...
df_by_sea.to_csv('salaries_per_season.csv',index = False)
...
df_by_pos.to_csv('salaries_per_pos.csv',index = False)
...
df_by_postot.to_csv('salaries_per_pos_total.csv',index = False)
...
df_by_posteam.to_csv('salaries_per_pos_per_team.csv',index = False)